...
axios.get(myConfig.config.base_url)
        ...
        <TableBody>
          {data.map((row) => (
            <StyledTableRow key={row.id} >
              ...
              <StyledTableCell align="center" onClick= {() => updateData(row.val5)}><Button color="primary">Update</Button></StyledTableCell>
              <StyledTableCell align="center" onClick= {() => delData(row.val5)}><Button color="secondary">Delete</Button></StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
          <Button color="primary" onClick= {() => addData()}>Add data</Button>
    </TableContainer>
    </Container>    
  );
